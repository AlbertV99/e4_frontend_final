...
export default function FichaClinica({navigation}) {
    ...
    const obtenerDatos = async ()=>{
        ...
        temp = await peticionesGet("tipoProducto",{})
        ...
        <Provider>
            <Portal>
                ...
                <Modal visible={visibleProducto} onDismiss={()=>setVisibleProducto(false)} contentContainerStyle={containerStyle}>
                    <Lista lista={productos} identificador="idTipoProducto" dato="descripcion" evento={(valor)=>{guardarDatos("idProducto",valor);setVisibleProducto(false)}}></Lista>
                </Modal>
            </Portal>
